...
// <Mascot concept="pip|fox|owl" state="idle|cheer|encourage|point|sleep" size={120} flip={false} />
(function () {
  const PALETTE = {
  ...
  function Mascot({ concept = 'pip', state = 'idle', size = 120, flip = false, decorative = true }) {
  ...
  window.MASCOT_CONCEPTS = ['pip', 'fox', 'owl', 'bear', 'bunny', 'monster'];
})();
